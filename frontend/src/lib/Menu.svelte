...
<div class="absolute w-full bottom-0 mb-5">
	<button
		...
		class="mx-auto w-12 h-12 bg-surface-900 border rounded-full flex justify-center items-center"
	>
		<svg class="w-1/2 h-1/2" fill="#f1f5f9" viewBox="0 0 330 330">
			<path
...
<Drawer position="bottom">
	<nav class="flex flex-col w-full bg-surface-800 p-3 justify-between rounded-t-md">
